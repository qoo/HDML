...
streams = data_provider.get_streams_noFlip(FLAGS.batch_size, FLAGS.dataSet, method, crop_size=FLAGS.default_image_size)
            ...
            for batch in copy.copy(epoch_iterator):
                ...
                if step % bp_epoch == 0:
                    ...
                    if nmi_te > max_nmi:
                        max_nmi = nmi_te
                        print("Saved")
                        saver.save(sess, os.path.join(LOGDIR, "modelBest.ckpt"))
